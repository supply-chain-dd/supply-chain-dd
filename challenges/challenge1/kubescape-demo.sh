...
p "═══════════════════════════════════════════════════════"
p "  PHASE 1 — AVANT : diagnostic de la pipeline vulnérable"
p "═══════════════════════════════════════════════════════"
...
p "3. Contrôle C-0260 : quels pods n'ont pas de NetworkPolicy ?"
pe "kubectl kubescape scan control C-0260 -v --include-namespaces ctf-challenge"

p "4. Le ServiceAccount 'default' peut lire les secrets (c'est le problème)"
...
p "5. Application de la pipeline SÉCURISÉE (RBAC + pipeline patché)"
pe "make -C ${PROJECT_ROOT} setup-ctf-challenge-secure"

p "6. Application des Network Policies"
...
p "7. RBAC — le SA 'pr-pipeline-readonly' ne peut PAS lire les secrets"
...
p "8. Création d'un PipelineRun avec le SA pr-pipeline-readonly"
...
p "9. Scan du pod quality-check de la pipeline SÉCURISÉE"
...
p "10. Re-vérification C-0260 après application des NetworkPolicies"
pe "kubectl kubescape scan control C-0260 -v --include-namespaces ctf-challenge"
