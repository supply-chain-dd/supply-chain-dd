#!/bin/bash
#
# Seed recipe-api repository to CI cluster Gitea
# This creates and populates the repository used for deep dive challenges
#
...
echo "==> Seeding recipe-api repository to CI cluster Gitea..."
...
# Push to Gitea
echo "Pushing to CI cluster Gitea..."
# Construct URL with embedded credentials
GITEA_URL_WITH_CREDS="http://$GITEA_USER:$GITEA_PASS@${GITEA_HOST}"
...
echo ""
echo "Next steps:"
echo "  1. Setup deep dive challenge: make setup-ci-pr-pipeline"
echo "  2. Test pull request trigger"
echo "  3. Start attack: challenges/challenge1/ATTACK-GUIDE.md"
echo ""
